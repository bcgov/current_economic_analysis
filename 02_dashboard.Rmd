...
plotly_ts <- function(df, thing, format_as, tt_text){
  ...
  plotly::ggplotly(plt, tooltip="text")%>%
    plotly::layout(annotations = list(text = paste("Source: ",df$Source[1]),
                              font = list(size = 10),
                              showarrow = FALSE,
                              xref = 'paper', x = 1,
                              yref = 'paper', y = -0.06))
...
- This dashboard allows you to visualize and download the data for `r dim(nested_dataframe)[1]` time series pertinent to British Columbia's current economic outlook. 
- This dashboard also contains recent information on the [Major Project Inventory](https://richard-martin.shinyapps.io/Major_Project_Inventory/).
